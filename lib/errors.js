...
class InvalidPluginOptionsError extends Error {
  constructor(props) {
    super(props)

    this.name = 'InvalidPluginOptionsError'
  }
}

module.exports = { ValidationError, NotFoundError, InvalidPluginOptionsError }
